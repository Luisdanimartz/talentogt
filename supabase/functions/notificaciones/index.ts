...
//
// La llaman los Database Webhooks de Supabase cuando:
//  1. Se crea un perfil de candidato  -> bienvenida + consejos
//  2. Se inserta un evento en application_status_history:
//     - status = "applied" -> confirma al candidato y avisa al reclutador
//     - otro status        -> avisa al candidato el cambio de estado
//
