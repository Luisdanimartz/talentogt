    ...
    <div className="container">
      ...
      <section className="hero">
        ...
        <p>
          ...
          mantienen informados a los candidatos durante todo el proceso de
          selección.
        </p>
      ...
      <section className="companies">
        ...
        <div className="companies-grid">
          <div className="company">Banco Industrial</div>
          <div className="company">Tigo Guatemala</div>
          <div className="company">Cementos Progreso</div>
          <div className="company">Farmacias Batres</div>
        </div>
      </section>
