...
const ESTADOS_ACADEMICOS = [
  ...
  { value: "cierre_pensum", label: "Cierre de pénsum" },
  { value: "estudiando", label: "Actualmente estudiando" },
];
      ...
      <Paper elevation={3} sx={{ p: 5, borderRadius: 4 }}>
        ...
        {education.map((edu, index) => (
          ...
          >
            ...
            <Grid item xs={12} md={4}>
              <TextField
                label="Carrera o título obtenido"
                value={edu.career_name || ""}
                onChange={(e) =>
                  updateEducation(index, "career_name", e.target.value)
                }
                fullWidth
                autoComplete="off"
            ...
            <Grid item xs={12} md={4}>
              <TextField
                ...
                value={edu.status || "graduado"}
                onChange={(e) =>
                  updateEducation(index, "status", e.target.value)
                }
                fullWidth
              >
                {ESTADOS_ACADEMICOS.map((item) => (
            ...
            <Grid item xs={12} md={4}>
              <TextField
                label={
                  edu.status === "estudiando"
                    ? "Año esperado de graduación"
                    : edu.status === "cierre_pensum"
                      ? "Año de cierre de pénsum"
                      : "Año de graduación"
                }
